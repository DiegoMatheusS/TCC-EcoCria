...
namespace ECOCRIA.Migrations
{
    ...
    [Migration("20241014201658_TBCONTATO")]
    partial class TBCONTATO
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Coletas", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdColeta = 1,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6978)
                        },
                        new
                        {
                            IdColeta = 2,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6992)
                        },
                        new
                        {
                            IdColeta = 3,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6993)
                        },
                        new
                        {
                            IdColeta = 4,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6994)
                        },
                        new
                        {
                            IdColeta = 5,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6996)
                        },
                        new
                        {
                            IdColeta = 6,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6997)
                        },
                        new
                        {
                            IdColeta = 7,
                            MomentoColeta = new DateTime(2024, 10, 14, 17, 16, 57, 929, DateTimeKind.Local).AddTicks(6998)
                        });
                });
