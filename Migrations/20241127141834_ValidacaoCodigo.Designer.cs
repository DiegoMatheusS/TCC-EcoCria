...
namespace ECOCRIA.Migrations
{
    ...
    [Migration("20241127141834_ValidacaoCodigo")]
    partial class ValidacaoCodigo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Coletas", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdColeta = 1,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(814)
                        },
                        new
                        {
                            IdColeta = 2,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(818)
                        },
                        new
                        {
                            IdColeta = 3,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(820)
                        },
                        new
                        {
                            IdColeta = 4,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(822)
                        },
                        new
                        {
                            IdColeta = 5,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(824)
                        },
                        new
                        {
                            IdColeta = 6,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(825)
                        },
                        new
                        {
                            IdColeta = 7,
                            MomentoColeta = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(827)
                        });
                });
            ...
            modelBuilder.Entity("Models.Comentarios", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdComentario = 1,
                            MomentoComentario = new DateTime(2024, 11, 27, 14, 18, 33, 224, DateTimeKind.Local).AddTicks(562),
